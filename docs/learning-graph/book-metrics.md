...
|---|---------|-------|--------|-------|
| 1 | Concepts | 242 | Required | Concepts from learning graph |
| 2 | Chapters | 14 | Required | Chapter directories with index.md |
| 3 | MicroSims | 115 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 14 / 14 | Recommended | Chapters with a quiz.md (182 questions total) |
| 6 | Chapter References | 0 / 14 | Recommended | Chapters with references.md (0 references total) |
| 7 | Glossary Terms | 252 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 71 | Recommended | Questions in faq.md |
| 9 | Words | 172,740 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 66 | 66 | H4 headers starting with '#### Diagram:' |
| Equations | 56 | 15 | LaTeX expressions (inline and display) |
| Total Words | 172,740 | 66,178 | Words in markdown files |
| Links | 1151 | 100 | Hyperlinks in markdown format |
| Equivalent Pages | 764 | 338 | Estimated pages (250 words/page + visuals) |
