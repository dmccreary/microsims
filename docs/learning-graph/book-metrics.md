...
| Concepts | 242 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 249 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 0 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 78 | - | Questions across all chapters |
| MicroSims | 90 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
| Equations | 31 | 15 | LaTeX expressions (inline and display) |
| Total Words | 134,402 | 55,189 | Words in markdown files |
| Links | 778 | 80 | Hyperlinks in markdown format |
| Equivalent Pages | 598 | 282 | Estimated pages (250 words/page + visuals) |
