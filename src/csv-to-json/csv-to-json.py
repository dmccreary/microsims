# Convert a Learning Graph CSV file to vis.js JSON format 
## We Read In a File ike this
# ID,ConceptName,Dependencies,CategoryID
    ...
    with open(csv_filename, 'r', newline='', encoding='utf-8') as csvfile:
        ...
        for row in reader:
            ...
            try:
                ...
                print(f"Invalid Category ID '{row['CategoryID']}' for ID {concept_id} skipped.")
