...
def create_thumbnail(image_path, thumbnail_path, size=(64, 64)):
...
def process_simulation_dir(directory, thumbnails_dir, gallery_lines):
    ...
    gallery_lines.append(f"[{title}](../sims/{simID}) ![thumbnail](./thumbnails/{simID}.png)")
...
gallery_dir = project_dir + 'src/gallery/'
...
if gallery_content:
    ...
    gallery_content = header_row + separator_row + gallery_content
